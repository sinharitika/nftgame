...
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
            ...
            <p class="footer__tagline">"lorem ipsum is simply a dummy text<br /> and nothing else.”</p>
        ...
        {/* <div class="col-8 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0">
            <h6 class="footer__title">NTF Marketplace</h6>
            <div class="footer__nav">
                <a href="explore.html">Browse</a>
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
                <h6 class="footer__title">Help & FAQ</h6>
            <div class="footer__nav">
                <a href="token.html">FAQ</a>
                <a href="blog.html">Documentation / Press kit</a>
                <Link to="/faq">Terms of Service</Link>
                <Link to="/privacy">Privacy</Link>
                <a href="contacts.html">Code of Conduct</a>
                <a href="contacts.html">Support</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="footer__content">
                ...
                <small class="footer__copyright">© NFT Game, 2021. Created by Rajjat.</small>
            </div>
        </div>
    </div>
</div>
